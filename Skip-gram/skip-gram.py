...
class BuildVocab(object):
    ...
    Args:
        ...
        :return:
    """
    def __init__(self, MAX_VOCAB_SIZE,EMBEDDIG_SIZE):
        self.VOCAB_SIZE = MAX_VOCAB_SIZE
        self.EMBEDDIG_SIZE = EMBEDDIG_SIZE
        self.vocab = dict()
        self.idx_to_word = []
...
class WordEmbeddingDataset(Dataset):
    ...
    def __getitem__(self, idx):
        center_word = self.text_encoded[idx] # longtensor
...
class ModelEvaluate(object):
    def __init__(self, model, file, embedding_weights, word_to_idx, idx_to_word):
...
def main():
    ...
    model_train(model, dataloader, EMBEDDING_SIZE, LEARNING_RATE, NUM_EPOCHS, vnum = 100)
